...
class TEIM(nn.Module):
    def __init__(self, config, dim_hidden, layers_inter, dim_seqlevel):
        super().__init__()
        self.dim_hidden = dim_hidden  # hidden dimension: [64, 128, 256]
        self.layers_inter = layers_inter  # layers of the inter-layer: [2, 3, 4]
        self.dim_seqlevel = dim_seqlevel   # dim of seq level output layer: [64, 128]
